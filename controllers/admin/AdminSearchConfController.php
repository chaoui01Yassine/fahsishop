    ...
    public function __construct()
    {
        ...
        $this->fields_options = [
            'indexation' => [
                ...
                'icon' => 'icon-cogs',
                'info' => '<p>
						' . $this->trans('The "indexed" products have been analyzed by fahsishop and will appear in the results of a front office search.', [], 'Admin.Shopparameters.Feature') . '<br />
