 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:q}=window;class F{extend(t){t.getHeaderContainer().on("click",o.gridSubmitAction,(e=>{this.handleSubmit(e,t)}))}handleSubmit(t,e){const o=q(t.currentTarget),s=o.data("confirm-message");if(void 0!==s&&s.length>0&&!window.confirm(s))return;const i=q(f(e.getId()));i.attr("action",o.data("url")),i.attr("method",o.data("method")),i.find(n.tokenInput(e.getId())).val(o.data("csrf")),i.submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class v{extend(t){const e=t.getContainer().find(u);e.find(b).prop("disabled",!0),e.find(h).on("input dp.change",(()=>{e.find(b).prop("disabled",!1),e.find(g).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:A}=window;A((()=>{const t=new x("logs");t.addExtension(new p),t.addExtension(new C),t.addExtension(new B),t.addExtension(new T),t.addExtension(new F),t.addExtension(new v)})),window.logs=e})();