 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:O}=window,T=function(t,e){O.post(t).then((()=>window.location.assign(e)))},{$:M}=window;class j{extend(t){t.getContainer().on("click",f,(t=>{T(M(t.currentTarget).data("url"),M(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class D{extend(t){const e=t.getContainer().find(u);new I(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:It}=window;class Dt{extend(e){e.getContainer().on("click",t.deleteCustomers,(n=>{n.preventDefault();const o=It(n.currentTarget).data("customers-delete-url"),i=It(t.deleteCustomerModal(e.getId()));i.modal("show"),i.on("click",t.submitDeleteCustomers,(()=>{e.getContainer().find(t.checkedCheckbox).each(((t,e)=>{const n=It(e);this.addCustomerToDeleteCollectionInput(n.val())}));const n=i.find("form");n.attr("action",o),n.submit()}))}))}addCustomerToDeleteCollectionInput(e){const n=It(t.customersToDelete),o=n.data("prototype").replace(/__name__/g,e),i=It(It.parseHTML(o)[0]);i.val(e),n.append(i)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;class Ht{constructor(t){this.id=t,this.$container=qt(`#${this.id}`)}getContainer(){return this.$container}addExtension(t){t.extend(this)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @copyright Since 2007 fahsishop and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const Qt="#customerRequiredFieldsAlertMessageOptin",Ut='#customerRequiredFieldsContainer input[type="checkbox"][value="optin"]',{$:Vt}=window;Vt((()=>{const t=new C("customer");t.addExtension(new E),t.addExtension(new B),t.addExtension(new j),t.addExtension(new D),t.addExtension(new F),t.addExtension(new Bt),t.addExtension(new Tt),t.addExtension(new St),t.addExtension(new Dt),t.addExtension(new Ft),t.addExtension(new Rt),t.addExtension(new Wt);const e=new C("customer_discount");e.addExtension(new jt),e.addExtension(new St);const n=new C("customer_address");n.addExtension(new jt),n.addExtension(new D),n.addExtension(new St);new Ht("customersShowcaseCard").addExtension(new Nt),new Lt,new $,function(){var t,e,n,o,i,s,r,a,c;const d=new URL(document.URL).hash.slice(1);if(""===d)return;const l=document.getElementById(d);if(!l)return;let u=0;if(l.offsetParent){let t=l;do{u+=t.offsetTop,t=t.offsetParent?t.offsetParent:null}while(null!==t)}u-=null!=(n=null==(e=null==(t=document.querySelector("#header_infos"))?void 0:t.getBoundingClientRect())?void 0:e.height)?n:0,u-=null!=(s=null==(i=null==(o=document.querySelector(".header-toolbar"))?void 0:o.getBoundingClientRect())?void 0:i.height)?s:0,u-=null!=(c=null==(a=null==(r=document.querySelector(".card-header"))?void 0:r.getBoundingClientRect())?void 0:a.height)?c:0,u-=10,window.scroll(0,u)}(),Vt(Ut).on("click",(()=>{Vt(Qt).toggleClass("d-none",!Vt(Ut).is(":checked"))}))}))})(),window.customer=o})();