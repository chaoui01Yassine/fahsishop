 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_}=window,y=function(t,e){_.post(t).then((()=>window.location.assign(e)))},{$:k}=window;class C{extend(t){t.getContainer().on("click",f,(t=>{y(k(t.currentTarget).data("url"),k(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class E{extend(t){t.getHeaderContainer().on("click",b,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function D(t){return void 0===t}var R=Object.defineProperty,q=Object.getOwnPropertySymbols,H=Object.prototype.hasOwnProperty,G=Object.prototype.propertyIsEnumerable,z=(t,e,n)=>e in t?R(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @copyright Since 2007 fahsishop and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const ft=N,{$:bt}=window;class pt{extend(e){e.getContainer().on("click",t.submitAction,(t=>{this.submit(t,e)}))}submit(t,e){const n=bt(t.currentTarget),o=n.data("confirm-message"),i=n.data("confirmTitle");void 0!==o&&o.length>0?void 0!==i?this.showConfirmModal(n,e,o,i):window.confirm(o)&&this.postForm(n,e):this.postForm(n,e)}showConfirmModal(t,e,n,o){const i=t.data("confirmButtonLabel"),r=t.data("closeButtonLabel"),a=t.data("confirmButtonClass");new ft({id:s(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:i,closeButtonLabel:r,confirmButtonClass:a},(()=>this.postForm(t,e))).show()}postForm(t,e){const n=bt(p(e.getId()));n.attr("action",t.data("form-url")),n.attr("method",t.data("form-method")),n.submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class vt{extend(t){const e=t.getContainer().find(h);new wt(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:_t}=window;class yt{extend(t){t.getContainer().on("click",".js-submit-row-action",(e=>{e.preventDefault();const n=_t(e.currentTarget),o=n.data("confirmMessage"),i=n.data("title"),s=n.data("method");if(i)this.showConfirmModal(n,t,o,i,s);else{if(o.length&&!window.confirm(o))return;this.postForm(n,s)}}))}postForm(t,e){const n=["GET","POST"].includes(e),o=_t("<form>",{action:t.data("url"),method:n?e:"POST"}).appendTo("body");n||o.append(_t("<input>",{type:"hidden",name:"_method",value:e})),o.submit()}showConfirmModal(t,e,n,o,i){const r=t.data("confirmButtonLabel"),a=t.data("closeButtonLabel"),c=t.data("confirmButtonClass");new N({id:s(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:r,closeButtonLabel:a,confirmButtonClass:c},(()=>this.postForm(t,i))).show()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:kt}=window;class Ct{extend(t){t.getContainer().find(h).find(d).on("click",(t=>{t.preventDefault(),this.toggleValue(kt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){kt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class Ot{constructor(){Et('input[id^="webservice_key_permissions_all"]').on("change",(t=>{const e=Et(t.currentTarget),n=e.is(":checked");e.closest("tr").find(`input:not(input[id="${e.attr("id")}"])`).each(((t,e)=>{Et(e).prop("checked",n)}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;jt((()=>{const t=new v("webservice_key");t.addExtension(new E),t.addExtension(new B),t.addExtension(new C),t.addExtension(new Ct),t.addExtension(new vt),t.addExtension(new pt),t.addExtension(new yt),t.addExtension(new j),t.addExtension(new xt),new window.prestashop.component.ChoiceTree("#webservice_key_shop_association").enableAutoCheckChildren(),window.prestashop.component.initComponents(["MultipleChoiceTable","GeneratableInput"]),window.prestashop.instance.generatableInput.attachOn(".js-generator-btn"),new Ot,window.prestashop.component.initComponents(["MultistoreConfigField"])}))})(),window.webservice=o})();