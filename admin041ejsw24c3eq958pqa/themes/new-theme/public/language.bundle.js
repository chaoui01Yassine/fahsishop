 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:F}=window;class I{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=F(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;F("tr",t.getContainer()).each((function(){const t=F(this);F(e.linkRowActionClickableFirst,t).each((function(){const o=F(this),i=o.closest("td"),s=F(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").mousedown((()=>{F(window).mousemove((()=>{r=!0,F(window).unbind("mousemove")}))})),s.mouseup((()=>{const t=r;if(r=!1,F(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(S(n)||S(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}var P=n(9567),D=Object.defineProperty,R=Object.getOwnPropertySymbols,q=Object.prototype.hasOwnProperty,H=Object.prototype.propertyIsEnumerable,z=(t,e,n)=>e in t?D(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,G=(t,e)=>{for(var n in e||(e={}))q.call(e,n)&&z(t,n,e[n]);if(R)for(var n of R(e))H.call(e,n)&&z(t,n,e[n]);return t};
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;Lt(document).ready((()=>{const t=new k("language");t.addExtension(new x),t.addExtension(new B),t.addExtension(new T),t.addExtension(new L),t.addExtension(new I),t.addExtension(new kt),t.addExtension(new Et),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new $t),new At("#language_shop_association").enableAutoCheckChildren()}))})(),window.language=o})();