 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ot}=window;Ot((()=>{const t=new w("address");t.addExtension(new k),t.addExtension(new B),t.addExtension(new x),t.addExtension(new j),t.addExtension(new M),t.addExtension(new wt),t.addExtension(new _t),t.addExtension(new kt),new Bt}))})(),window.address=o})();