 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:y}=window,w=function(t,e){y.post(t).then((()=>window.location.assign(e)))},{$:_}=window;class C{extend(t){t.getContainer().on("click",f,(t=>{w(_(t.currentTarget).data("url"),_(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class j{extend(t){t.getHeaderContainer().on("click",m,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
