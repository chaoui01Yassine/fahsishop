 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:E}=window,O=function(t,e){E.post(t).then((()=>window.location.assign(e)))},{$:x}=window;class B{extend(t){t.getContainer().on("click",f,(t=>{O(x(t.currentTarget).data("url"),x(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class A{extend(t){const e=t.getContainer().find(h);new T(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:M}=window;class S{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=M(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=M(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",y,(()=>e.submit()))}onExportSqlManagerClick(t){const e=M(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=M(u).find(m);let e="";return t.each(((t,n)=>{const o=M(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(t){t.getHeaderContainer().on("click",v,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:xt}=window;class Bt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=xt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;xt("tr",t.getContainer()).each((function(){const t=xt(this);xt(e.linkRowActionClickableFirst,t).each((function(){const o=xt(this),i=o.closest("td"),r=xt(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").mousedown((()=>{xt(window).mousemove((()=>{s=!0,xt(window).unbind("mousemove")}))})),r.mouseup((()=>{const t=s;if(s=!1,xt(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(N(n)||N(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @copyright Since 2007 fahsishop and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const jt=".js-form-submit-btn",{$:Tt}=window;class At{constructor(){Tt(document).on("click",jt,(t=>{t.preventDefault();const e=Tt(t.target);if(e.data("form-confirm-message")&&!1===window.confirm(e.data("form-confirm-message")))return;let n="POST",o=null;if(e.data("method")){const t=e.data("method"),i=["GET","POST"].includes(t);n=i?t:"POST",i||(o=Tt("<input>",{type:"_hidden",name:"_method",value:t}))}const i=Tt("<form>",{action:e.data("form-submit-url"),method:n});o&&i.append(o),e.data("form-csrf-token")&&i.append(Tt("<input>",{type:"_hidden",name:"_csrf_token",value:e.data("form-csrf-token")})),i.appendTo("body").submit()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:St}=window;class Lt{extend(t){t.getContainer().find(h).find(d).on("click",(t=>{t.preventDefault(),this.toggleValue(St(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){St("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;$t((()=>{const t=new C("tax_rules_group");t.addExtension(new B),t.addExtension(new A),t.addExtension(new S),t.addExtension(new L),t.addExtension(new F),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Bt),t.addExtension(new Mt),t.addExtension(new Lt),new At}))})(),window.tax_rules_group=o})();