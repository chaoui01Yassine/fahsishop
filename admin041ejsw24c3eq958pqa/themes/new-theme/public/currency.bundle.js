 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:vt}=window,yt=function(t,e){vt.post(t).then((()=>window.location.assign(e)))},{$:_t}=window;class kt{extend(t){t.getContainer().on("click",f,(t=>{yt(_t(t.currentTarget).data("url"),_t(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:xt}=window;class Et{extend(t){t.getContainer().find(h).find(d).on("click",(t=>{t.preventDefault(),this.toggleValue(xt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){xt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;class Tt{constructor(){this.initEvents()}initEvents(){jt(document).on("change",".js-live-exchange-rate",(t=>this.initLiveExchangeRate(t)))}initLiveExchangeRate(t){const e=jt(t.currentTarget),n=e.closest("form").serialize();jt.ajax({type:"POST",url:e.attr("data-url"),data:n}).then((t=>{if(!t.status)return window.showErrorMessage(t.message),void this.changeTextByCurrentSwitchValue(e.val());window.showSuccessMessage(t.message),this.changeTextByCurrentSwitchValue(e.val())})).fail((t=>{void 0!==t.responseJSON&&(window.showErrorMessage(t.responseJSON.message),this.changeTextByCurrentSwitchValue(e.val()))}))}changeTextByCurrentSwitchValue(t){const e=parseInt(t,10);jt(".js-exchange-rate-text-when-disabled").toggleClass("d-none",0!==e),jt(".js-exchange-rate-text-when-enabled").toggleClass("d-none",1!==e)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Mt{extend(t){const e=t.getContainer().find(b);e.find(p).prop("disabled",!0),e.find(w).on("input dp.change",(()=>{e.find(p).prop("disabled",!1),e.find(g).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:At}=window;class St{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=At(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;At("tr",t.getContainer()).each((function(){const t=At(this);At(e.linkRowActionClickableFirst,t).each((function(){const o=At(this),i=o.closest("td"),s=At(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").mousedown((()=>{At(window).mousemove((()=>{r=!0,At(window).unbind("mousemove")}))})),s.mouseup((()=>{const t=r;if(r=!1,At(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(F(n)||F(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;Lt((()=>{const t=new C("currency");t.addExtension(new E),t.addExtension(new mt),t.addExtension(new bt),t.addExtension(new wt),t.addExtension(new kt),t.addExtension(new Ct),t.addExtension(new Et),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new St),new Tt}))})(),window.currency=o})();