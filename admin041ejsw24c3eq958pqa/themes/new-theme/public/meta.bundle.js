 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Mt}=window;class At{extend(t){const e=t.getContainer();e.on("click",".js-remove-helper-block",(t=>{e.remove();const n=Mt(t.target),o=n.data("closeUrl"),i=n.data("cardName");o&&Mt.post(o,{close:1,name:i})}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class $t{constructor({tokenFieldSelector:t,options:e={}}){Tt(t).tokenfield(e);const n=e.maxCharacters||0;if(n>0){Tt(t).siblings(".token-input").prop("maxlength",n)}}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const It=new(n(7187).EventEmitter),{$:Pt}=window;const Ft=class{constructor(t={}){const e=t||{};this.localeItemSelector=e.localeItemSelector||".js-locale-item",this.localeButtonSelector=e.localeButtonSelector||".js-locale-btn",this.localeInputSelector=e.localeInputSelector||".js-locale-input",this.selectedLocale=Pt(this.localeItemSelector).data("locale"),Pt("body").on("click",this.localeItemSelector,this.toggleLanguage.bind(this)),It.on("languageSelected",this.toggleInputs.bind(this))}refreshInputs(t){this.selectedLocale&&It.emit("languageSelected",{selectedLocale:this.selectedLocale,form:t})}toggleLanguage(t){const e=Pt(t.target),n=e.closest("form");this.selectedLocale=e.data("locale"),this.refreshInputs(n)}toggleInputs(t){const{form:e}=t;this.selectedLocale=t.selectedLocale;const n=e.find(this.localeButtonSelector),o=n.data("change-language-url");n.text(this.selectedLocale.toUpperCase()),e.find(this.localeInputSelector).addClass("d-none"),e.find(`${this.localeInputSelector}.js-locale-${this.selectedLocale}`).removeClass("d-none"),o&&this.saveSelectedLanguage(o,this.selectedLocale)}saveSelectedLanguage(t,e){Pt.post({url:t,data:{language_iso_code:e}})}};
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Rt{extend(t){const e=t.getContainer().find(f);e.find(p).prop("disabled",!0),e.find(g).on("input dp.change",(()=>{e.find(p).prop("disabled",!1),e.find(b).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;class qt{constructor(){const t=".js-meta-page-name",e=Dt(t).val();this.setUrlRewriteDisabledStatusByCurrentPage(e),Dt(document).on("change",t,(t=>this.changePageNameEvent(t)))}changePageNameEvent(t){const e=Dt(t.currentTarget).val();this.setUrlRewriteDisabledStatusByCurrentPage(e)}setUrlRewriteDisabledStatusByCurrentPage(t){Dt(".js-url-rewrite input").prop("disabled","index"===t)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @copyright Since 2007 fahsishop and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const Ht=".js-current-length",Nt=".js-recommended-length-input",{$:Ut}=window;class Wt{constructor(){Ut(document).on("input",Nt,(t=>{const e=Ut(t.currentTarget),n=e.val();Ut(e.data("recommended-length-counter")).find(Ht).text(n.length)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;zt((()=>{const t=new C("meta");t.addExtension(new k),t.addExtension(new L),t.addExtension(new B),t.addExtension(new A),t.addExtension(new I),t.addExtension(new F),t.addExtension(new Et),t.addExtension(new jt),t.addExtension(new xt),t.addExtension(new Rt);new St("seo-urls-showcase-card").addExtension(new At),new $t({tokenFieldSelector:"input.js-taggable-field",options:{createTokensOnBlur:!0}}),new Ft,new qt,window.prestashop.component.initComponents(["MultistoreConfigField"]),new Wt}))})(),window.meta=o})();