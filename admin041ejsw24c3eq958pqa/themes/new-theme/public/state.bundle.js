 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:O}=window,j=function(t,e){O.post(t).then((()=>window.location.assign(e)))},{$:M}=window;class A{extend(t){t.getContainer().on("click",f,(t=>{j(M(t.currentTarget).data("url"),M(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(t){const e=t.getContainer().find(h);new S(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
function W(t){return void 0===t}var Q=Object.defineProperty,V=Object.getOwnPropertySymbols,U=Object.prototype.hasOwnProperty,J=Object.prototype.propertyIsEnumerable,K=(t,e,n)=>e in t?Q(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class xt{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=Et(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const s=Et(y(e.getId()));s.attr("action",n.data("url")),s.attr("method",n.data("method")),s.find(i.tokenInput(e.getId())).val(n.data("csrf")),s.submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;class Mt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=jt(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;jt("tr",t.getContainer()).each((function(){const t=jt(this);jt(e.linkRowActionClickableFirst,t).each((function(){const o=jt(this),i=o.closest("td"),s=jt(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").mousedown((()=>{jt(window).mousemove((()=>{r=!0,jt(window).unbind("mousemove")}))})),s.mouseup((()=>{const t=r;if(r=!1,jt(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(W(n)||W(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class At{extend(t){const e=t.getContainer().find(b);e.find(p).prop("disabled",!0),e.find(w).on("input dp.change",(()=>{e.find(p).prop("disabled",!1),e.find(g).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Tt}=window;class St{extend(t){t.getContainer().find(r).on("click",d,(t=>{const e=Tt(t.currentTarget);e.hasClass("ps-switch")||t.preventDefault();const n=e.find("input:checked"),o=Boolean(n.val());Tt.post({url:e.data("toggle-url")}).then((t=>{if(t.status)return window.showSuccessMessage(t.message),void this.toggleButtonDisplay(e);this.showErrorMessage(t.message,n.prop("name"),!o)})).catch((t=>{const e=t.responseJSON;this.showErrorMessage(e.message,n.prop("name"),!o)}))}))}showErrorMessage(t,e,n){this.toggleSwitch(e,n),window.showErrorMessage(t)}toggleSwitch(t,e){const n=Tt(`[name="${t}"][value="1"]`),o=Tt(`[name="${t}"][value="0"]`);n.is(":checked")!==e&&n.prop("checked",e),o.is(":checked")===e&&o.prop("checked",!e)}toggleButtonDisplay(t){const e=t.hasClass("grid-toggler-icon-valid"),n=e?"grid-toggler-icon-not-valid":"grid-toggler-icon-valid",o=e?"grid-toggler-icon-valid":"grid-toggler-icon-not-valid",i=e?"clear":"check";t.removeClass(o),t.addClass(n),t.hasClass("material-icons")&&t.text(i)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;class $t{constructor(){const t=new C("state");t.addExtension(new A),t.addExtension(new L),t.addExtension(new B),t.addExtension(new E),t.addExtension(new I),t.addExtension(new Ct),t.addExtension(new Ot),t.addExtension(new Mt),t.addExtension(new At),t.addExtension(new xt),t.addExtension(new St)}}Lt(document).ready((()=>{new $t}))})(),window.state=o})();