 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:A}=window,B=function(t,e){A.post(t).then((()=>window.location.assign(e)))},{$:S}=window;class M{extend(t){t.getContainer().on("click",w,(t=>{B(S(t.currentTarget).data("url"),S(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(t){t.getHeaderContainer().on("click",k,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:P}=window;class ${extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=P(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=P(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",T,(()=>e.submit()))}onExportSqlManagerClick(t){const e=P(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=P(g).find(v);let e="";return t.each(((t,n)=>{const o=P(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class z{extend(t){const e=t.getContainer().find(p);new I(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:H}=window;class N{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=H(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;H("tr",t.getContainer()).each((function(){const t=H(this);H(e.linkRowActionClickableFirst,t).each((function(){const o=H(this),i=o.closest("td"),r=H(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").mousedown((()=>{H(window).mousemove((()=>{s=!0,H(window).unbind("mousemove")}))})),r.mouseup((()=>{const t=s;if(s=!1,H(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(F(n)||F(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:q}=window;class G{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=q(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const r=q(O(e.getId()));r.attr("action",n.data("url")),r.attr("method",n.data("method")),r.find(i.tokenInput(e.getId())).val(n.data("csrf")),r.submit()}}var W=n(9567),V=Object.defineProperty,Y=Object.getOwnPropertySymbols,Q=Object.prototype.hasOwnProperty,X=Object.prototype.propertyIsEnumerable,U=(t,e,n)=>e in t?V(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,J=(t,e)=>{for(var n in e||(e={}))Q.call(e,n)&&U(t,n,e[n]);if(Y)for(var n of Y(e))X.call(e,n)&&U(t,n,e[n]);return t};
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @copyright Since 2007 fahsishop and Contributors
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */const Et=st,{$:At}=window;class Bt{extend(e){e.getContainer().on("click",t.submitAction,(t=>{this.submit(t,e)}))}submit(t,e){const n=At(t.currentTarget),o=n.data("confirm-message"),i=n.data("confirmTitle");void 0!==o&&o.length>0?void 0!==i?this.showConfirmModal(n,e,o,i):window.confirm(o)&&this.postForm(n,e):this.postForm(n,e)}showConfirmModal(t,e,n,o){const i=t.data("confirmButtonLabel"),s=t.data("closeButtonLabel"),a=t.data("confirmButtonClass");new Et({id:r(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:i,closeButtonLabel:s,confirmButtonClass:a},(()=>this.postForm(t,e))).show()}postForm(t,e){const n=At(O(e.getId()));n.attr("action",t.data("form-url")),n.attr("method",t.data("form-method")),n.submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:St}=window;class Mt{extend(t){t.getContainer().on("click",".js-submit-row-action",(e=>{e.preventDefault();const n=St(e.currentTarget),o=n.data("confirmMessage"),i=n.data("title"),r=n.data("method");if(i)this.showConfirmModal(n,t,o,i,r);else{if(o.length&&!window.confirm(o))return;this.postForm(n,r)}}))}postForm(t,e){const n=["GET","POST"].includes(e),o=St("<form>",{action:t.data("url"),method:n?e:"POST"}).appendTo("body");n||o.append(St("<input>",{type:"hidden",name:"_method",value:e})),o.submit()}showConfirmModal(t,e,n,o,i){const s=t.data("confirmButtonLabel"),a=t.data("closeButtonLabel"),l=t.data("confirmButtonClass");new st({id:r(e.getId()),confirmTitle:o,confirmMessage:n,confirmButtonLabel:s,closeButtonLabel:a,confirmButtonClass:l},(()=>this.postForm(t,i))).show()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class $t{extend(t){const e=t.getContainer().find(y);e.find(D).prop("disabled",!0),e.find(C).on("input dp.change",(()=>{e.find(D).prop("disabled",!1),e.find(_).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rt}=window;class It{constructor(){this.lockArray=[]}extend(e){e.getContainer().find(t.choiceOptions).find(b).on("click",(e=>{e.preventDefault();const n=Rt(e.currentTarget),o=n.closest(t.choiceOptions).data("url");this.submitForm(o,n)}))}submitForm(t,e){const n=e.data("value");if(this.isLocked(t))return;const o=Rt("<form>",{action:t,method:"POST"}).append(Rt("<input>",{name:"value",value:n,type:"hidden"}));o.appendTo("body"),o.submit(),this.lock(t)}isLocked(t){return this.lockArray.includes(t)}lock(t){this.lockArray.push(t)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:zt}=window;class Ft{extend(t){t.getContainer().find(p).find(m).on("click",(t=>{t.preventDefault(),this.toggleValue(zt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){zt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}n(3867);
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Ht}=window;class Nt{constructor(t){this.grid=t}extend(t){this.grid=t,this.addIdsToGridTableRows(),t.getContainer().find(s).tableDnD({onDragClass:x,dragHandle:a,onDrop:(t,e)=>this.handlePositionChange(e)}),t.getContainer().find(".js-drag-handle").hover((function(){Ht(this).closest("tr").addClass("hover")}),(function(){Ht(this).closest("tr").removeClass("hover")})),this.setReorderButtonLabel(),this.getReorderButton().on("click",(t=>this.oncClickReorderButton(t)))}handlePositionChange(t){const e=Ht(t).find(f(this.grid.getId())),n=e.data("update-url"),o=e.data("update-method"),i={positions:this.getRowsPositions()};this.updatePosition(n,i,o)}getRowsPositions(){const t=JSON.parse(Ht.tableDnD.jsonize())[`${this.grid.getId()}_grid_table`],e=[];let n;for(let o=0;o<t.length;o+=1)n=this.grid.getContainer().find(`#${t[o]}`),e.push({rowMarker:t[o],offset:n.data("dragAndDropOffset")});return this.computeMappingBetweenOldAndNewPositions(e)}addIdsToGridTableRows(){let t=0;this.grid.getContainer().find(u(this.grid.getId())).each(((e,n)=>{const o=Ht(n),i=`row_${o.data("id")}_${o.data("position")}`;o.closest("tr").attr("id",i),o.closest("td").addClass(l),o.closest("tr").data("dragAndDropOffset",t),t+=1}))}updatePosition(t,e,n){const o=["GET","POST"].includes(n),i=Ht("<form>",{action:t,method:o?n:"POST"}).appendTo("body"),r=e.positions.length;let s;for(let t=0;t<r;t+=1)s=e.positions[t],i.append(Ht("<input>",{type:"hidden",name:`positions[${t}][rowId]`,value:s.rowId}),Ht("<input>",{type:"hidden",name:`positions[${t}][oldPosition]`,value:s.oldPosition}),Ht("<input>",{type:"hidden",name:`positions[${t}][newPosition]`,value:s.newPosition}));o||i.append(Ht("<input>",{type:"hidden",name:"_method",value:n})),i.submit()}computeMappingBetweenOldAndNewPositions(t){var e;const n=new RegExp("^row_(?<rowId>\\d+)_(?<oldPosition>\\d+)$"),o=[];for(let i=0;i<t.length;i+=1){const r=n.exec(t[i].rowMarker);if(r&&!F(r.groups)&&!F(r.groups.rowId)&&!F(r.groups.oldPosition)){const t=parseInt(null==(e=null==r?void 0:r.groups)?void 0:e.oldPosition,10);o[i]={rowId:r.groups.rowId,oldPosition:t,newPosition:t}}for(let e=0;e<t.length;e+=1)F(t[e])||F(t[e].offset)||F(o[t[e].offset])||F(o[e])||(o[t[e].offset].newPosition=o[e].oldPosition)}return o}isPositionsReorderActive(){return this.grid.getContainer().find('.ps-sortable-column[data-sort-col-name="position"]').first().data("sort-is-current")}getReorderButton(){return this.grid.getContainer().find(".js-btn-reorder-positions").first()}setReorderButtonLabel(){const t=this.getReorderButton(),e=this.isPositionsReorderActive()?t.data("label-save"):t.data("label-reorder");t.html(e)}oncClickReorderButton(t){t.preventDefault(),this.isPositionsReorderActive()?this.grid.getContainer().find(".ps-sortable-column").first().click():this.grid.getContainer().find('.ps-sortable-column[data-sort-col-name="position"]').first().click()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;qt((()=>{const t=new E("customer_thread");t.addExtension(new M),t.addExtension(new L),t.addExtension(new $),t.addExtension(new z),t.addExtension(new N),t.addExtension(new G),t.addExtension(new Bt),t.addExtension(new Pt),t.addExtension(new $t),t.addExtension(new Ft),t.addExtension(new Mt),t.addExtension(new It),t.addExtension(new Nt(t))}))})(),window.customer_thread=o})();