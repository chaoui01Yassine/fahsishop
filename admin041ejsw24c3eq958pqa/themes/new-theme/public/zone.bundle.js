 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:E}=window,O=function(t,e){E.post(t).then((()=>window.location.assign(e)))},{$:B}=window;class A{extend(t){t.getContainer().on("click",b,(t=>{O(B(t.currentTarget).data("url"),B(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class j{extend(t){t.getHeaderContainer().on("click",y,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:T}=window;class M{extend(t){t.getHeaderContainer().on("click",i.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",i.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=T(i.showModalForm(t.getId()));this.fillExportForm(e,t);const n=T(i.showModalGrid(t.getId()));n.modal("show"),n.on("click",k,(()=>e.submit()))}onExportSqlManagerClick(t){const e=T(i.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const n=e.getContainer().find(r).data("query");t.find('textarea[name="sql"]').val(n),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=T(m).find(f);let e="";return t.each(((t,n)=>{const o=T(n),i=o.find("a").length>0?o.find("a").text():o.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(i)})),e}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(t){const e=t.getContainer().find(u);new S(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:I}=window;class P{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=I(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;I("tr",t.getContainer()).each((function(){const t=I(this);I(e.linkRowActionClickableFirst,t).each((function(){const o=I(this),i=o.closest("td"),s=I(e.clickableTd,t).not(i);let r=!1;s.addClass("cursor-pointer").mousedown((()=>{I(window).mousemove((()=>{r=!0,I(window).unbind("mousemove")}))})),s.mouseup((()=>{const t=r;if(r=!1,I(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(F(n)||F(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:D}=window;class R{extend(e){e.getHeaderContainer().on("click",t.gridSubmitAction,(t=>{this.handleSubmit(t,e)}))}handleSubmit(t,e){const n=D(t.currentTarget),o=n.data("confirm-message");if(void 0!==o&&o.length>0&&!window.confirm(o))return;const s=D(_(e.getId()));s.attr("action",n.data("url")),s.attr("method",n.data("method")),s.find(i.tokenInput(e.getId())).val(n.data("csrf")),s.submit()}}var q=n(9567),H=Object.defineProperty,z=Object.getOwnPropertySymbols,G=Object.prototype.hasOwnProperty,W=Object.prototype.propertyIsEnumerable,N=(t,e,n)=>e in t?H(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Q=(t,e)=>{for(var n in e||(e={}))G.call(e,n)&&N(t,n,e[n]);if(z)for(var n of z(e))W.call(e,n)&&N(t,n,e[n]);return t};
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Mt{extend(t){const e=t.getContainer().find(p);e.find(g).prop("disabled",!0),e.find(v).on("input dp.change",(()=>{e.find(g).prop("disabled",!1),e.find(w).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:$t}=window;class St{constructor(){this.lockArray=[]}extend(e){e.getContainer().find(t.choiceOptions).find(h).on("click",(e=>{e.preventDefault();const n=$t(e.currentTarget),o=n.closest(t.choiceOptions).data("url");this.submitForm(o,n)}))}submitForm(t,e){const n=e.data("value");if(this.isLocked(t))return;const o=$t("<form>",{action:t,method:"POST"}).append($t("<input>",{name:"value",value:n,type:"hidden"}));o.appendTo("body"),o.submit(),this.lock(t)}isLocked(t){return this.lockArray.includes(t)}lock(t){this.lockArray.push(t)}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Lt}=window;class Ft{extend(t){t.getContainer().find(u).find(d).on("click",(t=>{t.preventDefault(),this.toggleValue(Lt(t.delegateTarget))}))}toggleValue(t){const e=t.data("toggleUrl");this.submitAsForm(e)}submitAsForm(t){Lt("<form>",{action:t,method:"POST"}).appendTo("body").submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Dt}=window;Dt((()=>{const t=new x("zone");t.addExtension(new A),t.addExtension(new j),t.addExtension(new M),t.addExtension(new L),t.addExtension(new P),t.addExtension(new R),t.addExtension(new Ot),t.addExtension(new Tt),t.addExtension(new Mt),t.addExtension(new St),t.addExtension(new Ft),t.addExtension(new At),new Pt("#zone_shop_association").enableAutoCheckChildren()}))})(),window.zone=o})();