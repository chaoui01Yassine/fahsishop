 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:O}=window,x=function(t,e){O.post(t).then((()=>window.location.assign(e)))},{$:j}=window;class M{extend(t){t.getContainer().on("click",m,(t=>{x(j(t.currentTarget).data("url"),j(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class L{extend(t){const e=t.getContainer().find(d);new T(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$}=window;class F{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=$(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;$("tr",t.getContainer()).each((function(){const t=$(this);$(e.linkRowActionClickableFirst,t).each((function(){const o=$(this),i=o.closest("td"),r=$(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").mousedown((()=>{$(window).mousemove((()=>{s=!0,$(window).unbind("mousemove")}))})),r.mouseup((()=>{const t=s;if(s=!1,$(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(S(n)||S(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jt}=window;jt((()=>{const t=new k("order_message");t.addExtension(new C),t.addExtension(new B),t.addExtension(new M),t.addExtension(new L),t.addExtension(new F),t.addExtension(new xt),t.addExtension(new P),t.addExtension(new Et),t.addExtension(new Bt)}))})(),window.order_message=o})();