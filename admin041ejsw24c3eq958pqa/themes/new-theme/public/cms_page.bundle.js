 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:yt}=window,_t=function(t,e){yt.post(t).then((()=>window.location.assign(e)))},{$:Ct}=window;class Dt{extend(t){t.getContainer().on("click",v,(t=>{_t(Ct(t.currentTarget).data("url"),Ct(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class xt{extend(t){t.getHeaderContainer().on("click",D,(()=>{window.location.reload()}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Et}=window;class jt{constructor(t){this.onClick=t}extend(t){this.initRowLinks(t),this.initConfirmableActions(t)}initConfirmableActions(t){t.getContainer().on("click",e.linkRowAction,(t=>{const e=Et(t.currentTarget).data("confirm-message");e.length&&!window.confirm(e)&&t.preventDefault()}))}initRowLinks(t){const n=this.onClick;Et("tr",t.getContainer()).each((function(){const t=Et(this);Et(e.linkRowActionClickableFirst,t).each((function(){const o=Et(this),i=o.closest("td"),r=Et(e.clickableTd,t).not(i);let s=!1;r.addClass("cursor-pointer").mousedown((()=>{Et(window).mousemove((()=>{s=!0,Et(window).unbind("mousemove")}))})),r.mouseup((()=>{const t=s;if(s=!1,Et(window).unbind("mousemove"),!t){const t=o.data("confirm-message");(!t.length||window.confirm(t)&&o.attr("href"))&&(N(n)||N(o.get(0))?document.location.href=o.attr("href"):n(o.get(0)))}}))}))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Wt{extend(t){const e=t.getContainer().find(w);e.find(y).prop("disabled",!0),e.find(C).on("input dp.change",(()=>{e.find(y).prop("disabled",!1),e.find(_).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Jt}=window;Jt((()=>{const t=new j("cms_page_category");t.addExtension(new xt),t.addExtension(new Ot),t.addExtension(new Dt),t.addExtension(new A),t.addExtension(new jt),t.addExtension(new Lt),t.addExtension(new St),t.addExtension(new wt),t.addExtension(new Mt),t.addExtension(new Pt(t)),t.addExtension(new Wt);const e=new Nt;qt({sourceElementSelector:'input[name^="cms_page_category[name]"]',destinationElementSelector:`${e.localeInputSelector}:not(.d-none) input[name^="cms_page_category[friendly_url]"]`}),new Rt("#cms_page_category_parent_category");new Rt("#cms_page_category_shop_association").enableAutoCheckChildren(),new Ut({tokenFieldSelector:'input[name^="cms_page_category[meta_keywords]"]',options:{createTokensOnBlur:!0}});const n=new j("cms_page");n.addExtension(new xt),n.addExtension(new Ot),n.addExtension(new Dt),n.addExtension(new A),n.addExtension(new Mt),n.addExtension(new St),n.addExtension(new Lt),n.addExtension(new wt),n.addExtension(new Pt(n)),n.addExtension(new Wt),n.addExtension(new jt);new Yt("cms-pages-showcase-card").addExtension(new Xt)}))})(),window.cms_page=o})();