 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:j}=window;class C{extend(t){t.getHeaderContainer().on("click",n.showQuery,(()=>this.onShowSqlQueryClick(t))),t.getHeaderContainer().on("click",n.exportQuery,(()=>this.onExportSqlManagerClick(t)))}onShowSqlQueryClick(t){const e=j(n.showModalForm(t.getId()));this.fillExportForm(e,t);const o=j(n.showModalGrid(t.getId()));o.modal("show"),o.on("click",f,(()=>e.submit()))}onExportSqlManagerClick(t){const e=j(n.showModalForm(t.getId()));this.fillExportForm(e,t),e.submit()}fillExportForm(t,e){const o=e.getContainer().find(s).data("query");t.find('textarea[name="sql"]').val(o),t.find('input[name="name"]').val(this.getNameFromBreadcrumb())}getNameFromBreadcrumb(){const t=j(c).find(l);let e="";return t.each(((t,o)=>{const n=j(o),s=n.find("a").length>0?n.find("a").text():n.text();e.length>0&&(e=e.concat(" > ")),e=e.concat(s)})),e}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$}=window,y=function(t,e){$.post(t).then((()=>window.location.assign(e)))},{$:S}=window;class B{extend(t){t.getContainer().on("click",u,(t=>{y(S(t.currentTarget).data("url"),S(t.currentTarget).data("redirect"))}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class T{extend(t){const e=t.getContainer().find(d);new E(e).attach()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:q}=window;class v{extend(t){t.getHeaderContainer().on("click",o.gridSubmitAction,(e=>{this.handleSubmit(e,t)}))}handleSubmit(t,e){const o=q(t.currentTarget),s=o.data("confirm-message");if(void 0!==s&&s.length>0&&!window.confirm(s))return;const i=q(_(e.getId()));i.attr("action",o.data("url")),i.attr("method",o.data("method")),i.find(n.tokenInput(e.getId())).val(o.data("csrf")),i.submit()}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class F{extend(t){const e=t.getContainer().find(m);e.find(b).prop("disabled",!0),e.find(g).on("input dp.change",(()=>{e.find(b).prop("disabled",!1),e.find(h).prop("hidden",!1)}))}}
/**
 * Copyright since 2007 fahsishop and Contributors
 * fahsishop is an International Registered Trademark & Property of fahsishop
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:A}=window;A((()=>{const t=new x("authorization_server");t.addExtension(new p),t.addExtension(new C),t.addExtension(new B),t.addExtension(new T),t.addExtension(new v),t.addExtension(new F)})),window.authorization_server=e})();