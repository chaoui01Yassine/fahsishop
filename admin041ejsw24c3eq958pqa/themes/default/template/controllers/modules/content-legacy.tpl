	...
	{if isset($smarty.get.addnewmodule) && ($context_mode == Context::MODE_HOST)}
		...
		<div class="defaultForm form-horizontal">
				<div class="panel" id="">
					...
					<div class="form-wrapper">
						<div class="form-group">
							<p>{l s='To add a new module, simply connect to your fahsishop Addons account and all your purchases will be automatically imported.'}</p>
						</div>
					</div><!-- /.form-wrapper -->
				...
				<div class="alert alert-info">
					...
					<p>{l s='Please note that for security reasons, you can only add modules that are being distributed on fahsishop Addons, the official marketplace.'}</p>
				</div>
