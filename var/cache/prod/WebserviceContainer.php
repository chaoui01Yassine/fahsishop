...
class WebserviceContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'fahsist267.mysql.db', 'port' => '3306', 'dbname' => 'fahsist267', 'user' => 'fahsist267', 'password' => '8QfbDy5hfHZA', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/home/fahsist/www/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/home/fahsist/www/modules/productcomments/src/Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => '/home/fahsist/www/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/home/fahsist/www/var/cache/prod//doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('mod774_'))));
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/fahsist/www/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/fahsist/www/var/cache/prod//localization'))));
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('mod774_');
    }
    ...
    {
        return [
            'database_host' => 'fahsist267.mysql.db',
            'database_port' => '3306',
            'database_name' => 'fahsist267',
            'database_user' => 'fahsist267',
            'database_password' => '8QfbDy5hfHZA',
            'database_prefix' => 'mod774_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '64X7zXQ56Khw2qLZsnPXJDziehIjNxXjntORKPdZcnvLOEHjNLaLMFBzzF0rXsjN',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2026-05-23',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => 'IWU748eXmEmnMaIXjITWBGd4yNzJytQVOn4F48eG0S5GWKLideNMk1rMHrDGJ9xf',
            'cookie_iv' => 'IxO04FcR70hZptm0LuQ4XocoRYkAE7Jd',
            'new_cookie_key' => 'def00000290001da0ae4b4d628b4645b6a8e7d45c6814aec599fba9c86b7dc71fca985d4811c09c48dbaa68d74bf1296e27a3b13c76f6be53e84adecec1b9a5034ec73d3',
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA/L3HTbKMlajR9hPnZ4Vt'."\n".'EGgPeiJovXjVXQdHfcIsstPFHl/Hj/twtYPdj0i8XK21VL5o0m5R+Jrd1noXE3Z4'."\n".'/gTJeVcsvBNgC10Ahe0y38rZsdbsbuqUn+8AkdMDCFtC1qIv15gUdfFLhhAjpWr2'."\n".'qspG1iuHpYUeGXqw6AS6Bu7X8khZN4JJFLdskU73gsbPsMIWamFc6e4e8wynEA6D'."\n".'1vVDv2E4cVn1GqrlOG1cBnBg3Y7dfNgjDDNMtkRyK4eIi199teZ4KU+ZrHQQyOHU'."\n".'q2AeYibHwZ0QmNr0GoK+1Ty5EdFT98COuQM/pBCN5HLpJqHTq3PHlh/BVaZH+sPv'."\n".'UQIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggSkAgEAAoIBAQD8vcdNsoyVqNH2'."\n".'E+dnhW0QaA96Imi9eNVdB0d9wiyy08UeX8eP+3C1g92PSLxcrbVUvmjSblH4mt3W'."\n".'ehcTdnj+BMl5Vyy8E2ALXQCF7TLfytmx1uxu6pSf7wCR0wMIW0LWoi/XmBR18UuG'."\n".'ECOlavaqykbWK4elhR4ZerDoBLoG7tfySFk3gkkUt2yRTveCxs+wwhZqYVzp7h7z'."\n".'DKcQDoPW9UO/YThxWfUaquU4bVwGcGDdjt182CMMM0y2RHIrh4iLX3215ngpT5ms'."\n".'dBDI4dSrYB5iJsfBnRCY2vQagr7VPLkR0VP3wI65Az+kEI3kcukmodOrc8eWH8FV'."\n".'pkf6w+9RAgMBAAECggEAFx+V2Hn5esfTTdxMU6BVdibPI7F6O7uOadB8rfjR9hqB'."\n".'8mF49KdgjHrgDnftI92QtYwmMvp87W3d1f2dlt5D+5mchUmAgkSTiPadUaN+ABOj'."\n".'Dy5Gu28i4e8P8keIA3+2AcUc83Cqjo/hBQb8++lpX/7ZtEaPRomDU3lyLgggrPmG'."\n".'pOPRuqhVwIsiCnseD/oAuxx8gOXsaigL+kmOJFVwemQXVqfOskwewByumb+j1ZAE'."\n".'dORi6o+AnzfOPY5t8E6o/F82z926reIPhBSeo0wSzcHCF0DZRsJQoybX7Y8tQS3/'."\n".'72L01gFTpnPM/VycZQ6+63kb/m+DXXedo4ssOTohQQKBgQD+3U36Q/+bf+Nzq1sp'."\n".'X+a6cG7knfq7/0bFJoSFj9xNgokigACkEuW6l3awWHfvJj2YxtFpatso/Iy5j5fb'."\n".'wLIjGp/UX5VejcpcnSqj7lnGwXa+k9JdWXOVlgbOzQbGxKkUjAPooGvsUu3QgPF1'."\n".'D6zMaeRoafBzfpPEPILuLnvGTQKBgQD93g1i8bbrXcyEstbrjJXvHqEWPmDv0FV0'."\n".'rsAg6GPf7A0aINgRdhJ/U8BNMVNJeQ2i0eEnmwWM/K0AkDAcMUFGOppLnjE55s2W'."\n".'+DnEo2yjx+b9ZKlxFYWOlpN1jWT22qRU4TeiogpGL8yI4BtvhDPBGqr/V5CSjkhl'."\n".'0pIygFrXFQKBgQD3/yowe1hO3HvcAwK62Omvw1X0udDQfE9F6fwL5veMqJd+baWy'."\n".'Af1uupGwePWDTOelMNl2xZaqZE0fBx3SpMfyJqcdxUCYeEpQIlLqnzTWlUxRl4+c'."\n".'bD1vckP/mTud0KFiL/hhtTAvDmcAe2f4657Obb/m5icmiyWITwVsdOjWBQKBgCPz'."\n".'i0/EzVO9n9X3Aaqv6RfI7aUZxl6P0VpJ2RmP73zpj91wY0jtwKbZdHU6FAJmq0Cw'."\n".'mkMimAGkUteuk7GaZBUO/YTR7US248yKcJvhTORQzex6keha1OQhfNZ75J10zyra'."\n".'Difw7KWN5VhI7Hm5bh7dqPOqMeYfUi9hR6TxOmwVAoGBAJk/M6eHjByK9RF6feJ+'."\n".'r+RuIGkhkTQlpuXIE8iXYTGugGFd2eHZpkLhNzkyyS2DcLLdRdM+6xE7+XmhZK7a'."\n".'Zhgt4xXkDO91SKp7SdoI1kH3WzypS41uQaFsK2RhFTTdJiF0mN68vQRRYRFf+q61'."\n".'/sRv9CXZs/aAkECBZkPL4J+/'."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            'cache.adapter' => 'cache.adapter.array',
            'kernel.bundles' => [

            ],
            'kernel.root_dir' => '/home/fahsist/www/app',
            'kernel.project_dir' => '/home/fahsist/www',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/home/fahsist/www/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                61 => 'statsstock',
                62 => 'statscatalog',
                63 => 'ps_distributionapiclient',
                64 => 'statsproduct',
                65 => 'ps_themecusto',
            ],
            'ps_cache_dir' => '/home/fahsist/www/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/fahsist/www/var/cache/prod//doctrine/orm/Proxies',
