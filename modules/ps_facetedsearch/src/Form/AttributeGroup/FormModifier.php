...
class FormModifier
{
    ...
    {
        // Dynamically check the class and instanciate it, this avoids the module from requiring fahsishop 1.7.8 minimum,
        ...
        if (!class_exists('\PrestaShopBundle\Form\FormBuilderModifier')) {
            throw new CoreException('FormBuilderModifier class was not found, it is only available in fahsishop 1.7.8 and more');
        }
