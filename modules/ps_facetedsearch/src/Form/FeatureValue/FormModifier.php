...
class FormModifier
{
    ...
    public function modify(
        ...
        $urlTip = $translator->trans(
            ...
            'the word that best represents this feature. By default, fahsishop uses the ' .
        ...
        $metaTitleTip = $translator->trans(
            ...
            'choosing the word that best represents this feature. By default, fahsishop uses the ' .
            'feature\'s value, but you can change that setting using this field.',
            [],
            'Modules.Facetedsearch.Admin'
        );
