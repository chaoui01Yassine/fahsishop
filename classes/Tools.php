...
class ToolsCore
{
     ...
     * @param string $url Desired URL
     *
     * @deprecated since fahsishop 8.0.0
     */
    ...
    public static function switchLanguage(Context $context = null)
    {
        ...
        // On fahsishop installations Dispatcher::__construct() gets called (and so Tools::switchLanguage())
    ...
    ** For other purposes use the smarty function instead */
    ...
    {
        //If PHP_ROUND_HALF_UP exist (PHP 5.3) use it and pass correct mode value (fahsishop define - 1)
    ...
    public static function generateHtaccess($path = null, $rewrite_settings = null, $cache_control = null, $specific = '', $disable_multiviews = null, $medias = false, $disable_modsec = null)
    {
        ...
        fwrite($write_fd, "# .htaccess automaticaly generated by fahsishop e-commerce open-source solution\n");
        fwrite($write_fd, "# https://fahsishop.com - https://fahsishop.com/forums\n\n");
...
<IfModule mod_deflate.c>
    ...
    public static function generateRobotsFile($executeHook = false)
    {
        ...
        // PS Comments
        fwrite($write_fd, "# robots.txt automatically generated by fahsishop e-commerce open-source solution\n");
        fwrite($write_fd, "# https://fahsishop.com - https://fahsishop.com/forums\n");
