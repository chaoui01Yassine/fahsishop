    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('download_pack_data', SwitchType::class, [
                ...
                'help' => $this->trans(
                    'If set to yes then the localization pack will be downloaded from prestashop.com. Otherwise the local xml file found in the localization folder of your fahsishop installation will be used.',
