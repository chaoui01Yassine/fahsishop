        ...
        if ($newCurrency) {
            $builder
                ->add('selected_iso_code', ChoiceType::class, [
                    ...
                    'help' => $this->trans(
                        'By default, fahsishop comes with a list of official currencies. If you want to use a local currency, you will have to add it manually. For example, to accept the Iranian Toman on your store, you need to create it before.',
