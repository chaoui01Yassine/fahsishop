    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('forceIDs', SwitchType::class, [
                ...
                'help' => $this->trans('Enable this option to keep your imported items’ ID number as is. Otherwise, fahsishop will ignore them and create auto-incremented ID numbers.', 'Admin.Advparameters.Help'),
            ])
