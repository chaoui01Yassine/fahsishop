...
/**
 * Helper to manipulate the locales (IETF language tag) specific to fahsishop
 *
...
final class Converter
{
     ...
     *
     * @return string|bool the legacy fahsishop locale (like "fr")
     *
     * @throws Exception
     */
    ...
    /**
     * @param string $legacyLocale the legacy fahsishop locale
     *
    ...
    /**
     * Get the fahsishop locale from real locale (like "fr-FR")
     *
     * @param string $locale
     *
     * @return string The fahsishop locale (like "fr_FR")
     */
